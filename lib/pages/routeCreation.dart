import 'dart:convert';
import 'dart:core';
import 'package:capstone/pages/routeCreation_draft.dart';
...
class _MyWidgetState extends State<RouteCreation>
  ...
  final Polylinedecoder _polylineDecoder =
      Polylinedecoder('AIzaSyBcUDWZDnJBOX_Q5IOqDJi60RuqJy1-ZkY');
  ...
  void _fetchPolylineForExisting(LatLng pointA, LatLng pointB,
      Polyline nextPolyline, PolylineId polylineID) async {
    final polylinePoints =
        await _polylineDecoder.getRoutePolyline(pointA, pointB);
    setState(() {
      try {
  ...
  void _fetchPolyline() async {
    ...
    try {
      ...
      setState(() {
        ...
        DataManager().insert_decodedPolyline_ToDM(polylinePoints);
        ...
        if (nextExistingpolyline != null) {
          ...
          _fetchPolylineForExisting(
              nextExistingpolyline.points.first,
              nextExistingpolyline.points.last,
              nextExistingpolyline,
              nextPolylineid);
        }
      });
    } catch (e) {
  ...
  Future<String> _getAddress(LatLng position) async {
    try {
      ...
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        if (data['results'] != null && data['results'].isNotEmpty) {
          placeName = data['results'][1]['name']; //Get the first nearby place
                  ...
                  DraggableScrollableSheet(
                    ...
                    builder: (context, scrollController) {
                      ...
                      final keyboardHeight = MediaQuery.of(context)
                          .viewInsets
                          .bottom; // To check if the keyboard is visible
                                              ...
                                              onPressed: () async {
                                                setState(() {
                                                  ...
                                                  if (currentPages[
                                                    ...
                                                    String page = currentPages[
                                                        currentPageTracker + 1];
                                                    String next = DataManager()
                                                        .get_nextButton()!;
                                                    print(
                                                        "in current page: $page - from Data Manager: $next");
                                                    changeWidget_for_changedButton(
                                                        next);
                                                  }
                                                  if (currentPages[
                                                              currentPageTracker] ==
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        height: questionIsVisible
                                            ? 80
                                            : screenHeight -
                                                keyboardHeight -
                                                330, // Adjust for screen and keyboard
...
class _Page1State extends State<Page1> {
  ...
  void initState() {
    ...
    if (valuesInMap.length == 3) {
      textOriginController.text = valuesInMap[2][0];
      landmarkController.text = valuesInMap[2][1];
  ...
  void saveChangesToDataManager() {
    DataManager().getStepsInformation()[2][0] = textOriginController.text;
    DataManager().getStepsInformation()[2][1] = landmarkController.text;
  }
  ...
  void addToDataManager() {
    ...
    DataManager()
        .insertStepData([textOriginController.text, landmarkController.text]);
  }
...
class _WalkWidgetState extends State<WalkWidget> {
  ...
  void initState() {
    ...
    var valuesInMap = DataManager().get_accessOnValuesInMap();
    if (valuesInMap.length == 3) {
      locationName_controller.text = valuesInMap[2][0];
      landmarkName_controller.text = valuesInMap[2][1];
      instructions_controller.text = valuesInMap[2][2];
      if (DataManager().get_nextButton() != null) {
        nextButton = DataManager().get_nextButton()!;
        hasNextStep = true;
      } else {
  ...
  void saveChangesToDataManager() {
    DataManager().getStepsInformation()[2][0] = locationName_controller.text;
    DataManager().getStepsInformation()[2][1] = landmarkName_controller.text;
    DataManager().getStepsInformation()[2][2] = instructions_controller.text;
  }
  ...
  void insertToDataManager() {
    DataManager().insertStepData([
      locationName_controller.text,
      landmarkName_controller.text,
      instructions_controller.text
    ]);
  }
...
class _RideWidgetState extends State<RideWidget> {
  ...
  void initState() {
    ...
    if (valuesInMap.length == 3) {
      ...
      landmarkName_controller.text = valuesInMap[2][1];
      instructions_controller.text = valuesInMap[2][2];
      if (valuesInMap[2].length == 5) {
        fare_controller.text = valuesInMap[2][3];
        selectedVehicle = valuesInMap[2][4];
      }
      ...
      instructions_controller.addListener(saveChangesToDataManager);
      // instructions_controller.addListener(saveChangesToDataManager);
      if (DataManager().getStepsInformation()[2].length == 5 &&
          selectedVehicle != (DataManager().getStepsInformation()[2][4])) {
  ...
  void saveChangesToDataManager() {
    ...
    DataManager().getStepsInformation()[2][1] = landmarkName_controller.text;
    DataManager().getStepsInformation()[2][2] = instructions_controller.text;
    DataManager().getStepsInformation()[2][3] = fare_controller.text;
    DataManager().getStepsInformation()[2][4] = selectedVehicle;
  }

  void updateButtonInDataManager() {
    if (DataManager().getStepsInformation().length == 3 &&
        DataManager().getStepsInformation()[2].length == 5) {
      DataManager().getStepsInformation()[2][4] = selectedVehicle;
    }
  }
  ...
  bool allIsNotEmptyChecker() {
    ...
    int _true = 0;
    for (int ix = 0; ix < buttonClicked.length; ix++) {
      if (buttonClicked[ix] == true) {
        _true++;
      }
    }
    if (_true == 1) {
    ...
    print('_buttonClicked: $_buttonClicked');
    return locationName_controller.text.isNotEmpty &&
        instructions_controller.text.isNotEmpty &&
        fare_controller.text.isNotEmpty &&
        buttonClicked == true;
                ...
                children: [
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white,
                        backgroundColor: buttonClicked[0]
                            ? const Color(0xff1F41BB)
                            : const Color.fromARGB(255, 122, 143, 221),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white,
                        backgroundColor: buttonClicked[1]
                            ? const Color(0xff1F41BB)
                            : const Color.fromARGB(255, 122, 143, 221),
                        minimumSize: const Size(20, 25),
                      ),
                      child:
                          const Text('E-jeep', style: TextStyle(fontSize: 12)),
                    ),
                  ),
                  Container(
                    margin: const EdgeInsets.only(right: 5, bottom: 5),
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white,
                        backgroundColor: buttonClicked[2]
                            ? const Color(0xff1F41BB)
                            : const Color.fromARGB(255, 122, 143, 221),
                        minimumSize: const Size(20, 25),
                      ),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white,
                        backgroundColor: buttonClicked[3]
                            ? const Color(0xff1F41BB)
                            : const Color.fromARGB(255, 122, 143, 221),
                        minimumSize: const Size(20, 25),
                      ),
                      child: const Text('Tricycle',
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white,
                        backgroundColor: buttonClicked[4]
                            ? const Color(0xff1F41BB)
                            : const Color.fromARGB(255, 122, 143, 221),
                        minimumSize: const Size(20, 25),
                      ),
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        keyboardType: TextInputType
                            .number, // Set keyboard type for numeric input
...
class DataManager {
  ...
  void insertStepLocationData(
      int stepNumber, String step, List<dynamic> locationData) {
    if (stepsMap.containsKey(stepNumber)) {
