      ...
      appBar: AppBar(
        ...
        actions: [
          Row(
            children: [
              Container(
                 padding: const EdgeInsets.only(right: 20.0,left: 10.0,top:5.0,bottom:5.0),
              ...
              IconButton(
                icon: const Icon(Icons.account_circle_rounded,color: Colors.black,size: 35),
                onPressed: (){
      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: Container(
              padding: const EdgeInsets.only(right: 40.0,left: 40.0,top:30,bottom: 40),
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(20),
                boxShadow: [
              ...
              Row(
                children: [
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.only(right: 12.0,left: 11.0,top: 13,bottom:9.0),
                    ...
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.only(right: 12.0,left: 9.0,top: 13,bottom:9.0),
                        backgroundColor: Colors.white,
                        fixedSize: const Size(167,71),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10),
              ...
              Row(
                children: [
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.only(right: 12.0,left: 7.0,top: 13,bottom:9.0),
                        backgroundColor: Colors.white,
                        fixedSize: const Size(167,71),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10),
                    ...
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.only(right: 4.0,left: 10.0,top: 11.5,bottom:9.0),
                        backgroundColor: Colors.white, 
                        fixedSize: const Size(167,71),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10),
